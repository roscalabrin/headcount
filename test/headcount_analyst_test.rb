...
class HeadcountAnalystTest < Minitest::Test
  ...
  def test_comparison_participation_rate_of_district_against_state
    dr = DistrictRepository.new
  ...
  def test_comparison_participation_rate_of_district_against_another_district
    dr = DistrictRepository.new
    dr.load_data({:enrollment => {:kindergarten => "./data/Kindergartners in full-day program.csv"}})
    ha = HeadcountAnalyst.new(dr)
  ...
  def test_that_it_calculates_participation_rate_average
    ...
    assert_equal 0.4064509090909091, ha.average('ACADEMY 20')
  end
